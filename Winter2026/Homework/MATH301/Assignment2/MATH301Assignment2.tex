...
\begin{proof}
    Let $z=a+bi$ with $a,b\in\R$, then $f(z)=|z|=\sqrt{a^2+b^2}$. This question degrades to showing that $g:\R_{\geq0}\to \R_{\geq0}$ with $g(x)=\sqrt{x}$ is continuous. Let $\varepsilon>0$ and $\delta>0$ then
    \[
        |g(x)-g(x_0)|=|\sqrt{x}-\sqrt{x_0}|.
    \]
    It is obvious that 
    \[
        |\sqrt{x}-\sqrt{x_0}|=\left|\frac{x-y}{\sqrt{x}+\sqrt{x_0}}\right|\leq\left|\frac{x-y}{\sqrt{x_0}}\right|.
    \]
    Assuming that $|x-x_0|<\delta$ then we have
    \[
        |\sqrt{x}-\sqrt{x_0}|<\left|\frac{\delta}{\sqrt{x_0}}\right|.
    \]
    If $x_0\neq0$ then set $\delta=\varepsilon\sqrt{x_0}$. Then whenever $|x-x_0|<\delta$ we have
    \[
        |g(x)-g(x_0)|<\left|\frac{\delta}{\sqrt{x_0}}\right|=\left|\frac{\varepsilon\sqrt{x_0}}{\sqrt{x_0}}\right|=\varepsilon.
    \]
    In the case where $x_0=0$, set $\delta=\varepsilon^2$, then whenever $|x-x_0|<\delta$ we have
    \[
        |g(x)-g(x_0)|=|g(x)|=\sqrt{x}<\sqrt{\delta}=\sqrt{\varepsilon^2}+\varepsilon.
    \]
    Since we have shown that $g$ is continuous on $\R_{\geq0}$ we have also show that $f$ is continuous.
\end{proof}
\stepcounter{section}
\section*{Problem 9}
