...
\begin{enumerate}
	...
	\item Addition over reals is associative for we have $((x_1, x_2) \oplus (y_1, y_2))\oplus (w_1,w_2)=(x_1, x_2) \oplus ((y_1, y_2)\oplus (w_1,w_2))$;
	...
	\begin{align*}
		v\oplus(-v)&=\left( \sqrt[3]{x_1^3 + \sqrt[3]{-x_1^3-2}^3 + 1}, \sqrt[3]{x_2^3 + \sqrt[3]{-x_2^3-4}^3 + 2} \right)\\
...
\textit{Solution.}
Each of the vectors is identified with its upper-right entry $a \in \mathbb{R}$.
...
\[
	\det(AB)=\det(A)\det(B),
\] 
we have that there can be no matrix in $U$ with determinant equal to zero. Therefore, $U\neq M_{2\times 2}(\R)$.
\end{document}