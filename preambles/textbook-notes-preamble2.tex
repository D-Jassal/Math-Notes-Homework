...
%  Shared counter for Theorem, Lemma, Corollary only
...
%  Theorem
\newtcbtheorem[use counter=tcbtheorem, number within=chapter]
  {theorem}{Theorem}{
    enhanced, breakable,
...
\newtcolorbox{definition}[2][]{
  ...
  title={Definition\ifx\relax#2\relax\else\ --\ #2\fi},
...
\newtcolorbox{claim}[2][]{
  enhanced, breakable,
  colback=BoxBg!35, colframe=AccentMain!60,
  title={Claim\ifx\relax#2\relax\else\ --\ #2\fi},
  fonttitle=\bfseries,
  #1
}
...
\newtcolorbox{proposition}[2][]{
  enhanced, breakable,
  colback=BoxBg!40, colframe=AccentMain!50,
  title={Proposition\ifx\relax#2\relax\else\ --\ #2\fi},
  fonttitle=\bfseries,
  #1
}
...
\newtcolorbox{example}[2][]{
  ...
  title={Example\ifx\relax#2\relax\else\ --\ #2\fi},
