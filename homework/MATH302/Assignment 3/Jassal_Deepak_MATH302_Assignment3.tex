...
\begin{proof}
    ...
    \]
    Thus $F_n(x)$ is uniform bounded in [0,1].
...
\begin{enumerate}[label=(\alph*)]
    ...
    This is not possible in $\R^n$ for $n\geq2$ because the connected property of intervals in $\R$ does not extend to $\R^n$ for $n>1$. This can be seen in $\R^2$ since an interval in $\R^2$ is either a rectangle or a ball in the plane. These cannot be used to express all sets in $\R^2$ as unions that are disjoint. 
\end{enumerate}
