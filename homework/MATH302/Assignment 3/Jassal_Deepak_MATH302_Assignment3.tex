...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{proof}
        ...
        \[
            \left|\frac{2+\pi}{4n-2}\right|<\left|\frac{2+\pi}{4N-2}\right|=\left|\frac{2+\pi}{4\left(\dfrac{\frac{2+\pi}{\varepsilon}+2}{4}\right)-2}\right|=\left|\frac{2+\pi}{\frac{2+\pi}{\varepsilon}}\right|=\varepsilon.
        \]
    \end{proof}
